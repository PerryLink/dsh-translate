...
| Superfície | Status |
|---|---|
| Harness | Versão principal **`dsh-v0.1.7-alpha.2`** (verificado em 2026-09-18: typecheck duplo + `node --test` 80/80 + portas self-contained/artifacts). Os pins npm dev/test agora são `0.1.7-alpha.2`; peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
