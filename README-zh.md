...
| 方面 | 状态 |
|---|---|
| Harness | 主版本 **`dsh-v0.1.7-rc.2`**（2026-09-24 核验：双 typecheck 尺子 + `node --test` 80/80 + self-contained/artifacts 门）。npm dev/test 钉号已抬至 `0.1.7-rc.2`；peers 三段式 `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
