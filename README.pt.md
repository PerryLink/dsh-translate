...
| Superfície | Status |
|---|---|
| Harness | Versão principal **`dsh-v0.1.3-alpha.1`** (tag do GitHub, verificado em 2026-09-06: cadeia completa de portas + smoke de instalação de perfil). Linha de dependências npm fixada em `0.1.2-rc.1`; peers `>=0.1.2-rc.1 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
