...
| सतह | स्थिति |
|---|---|
| Harness | मुख्य संस्करण **`dsh-v0.1.7-alpha.1`** (2026-09-18 को सत्यापित: दोहरा typecheck + `node --test` 80/80 + self-contained/artifacts गेट)। npm dev/test पिन अब `0.1.6-alpha.2` हैं; peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`। |
| Node | `^22.19.0 \|\| >=24.0.0` |
