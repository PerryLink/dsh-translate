...
| Superficie | Estado |
|---|---|
| Harness | Versión principal **`dsh-v0.1.3-alpha.1`** (tag de GitHub, verificado el 2026-09-06: cadena completa de puertas + smoke de instalación de perfil). Línea de dependencias npm fijada en `0.1.2-rc.1`; peers `>=0.1.2-rc.1 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
