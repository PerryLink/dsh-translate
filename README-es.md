...
| Superficie | Estado |
|---|---|
| Harness | Versión principal **`dsh-v0.1.6-alpha.2`** (verificado el 2026-09-18: doble typecheck + `node --test` 80/80 + puertas self-contained/artifacts). Los pines npm dev/test ahora son `0.1.6-alpha.2`; peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
