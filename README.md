...
| Surface | Status |
|---|---|
| Harness | Main version **`dsh-v0.1.5-rc.1`** (GitHub tag, verified 2026-09-10: full gate chain + profile install smoke). npm dependency line pinned to `0.1.5-rc.1`; peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
