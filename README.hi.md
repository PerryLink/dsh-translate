...
| सतह | स्थिति |
|---|---|
| Harness | मुख्य संस्करण **`dsh-v0.1.5-alpha.1`** (GitHub tag, 2026-09-09 को सत्यापित: पूर्ण गेट श्रृंखला + प्रोफ़ाइल इंस्टॉल स्मोक)। npm निर्भरता पंक्ति `0.1.2-rc.1` पर टिकी है; peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`। |
| Node | `^22.19.0 \|\| >=24.0.0` |
